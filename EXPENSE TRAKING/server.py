...
def add_or_update_expense(expenses_date: date, expense:List[Expense]):
    db_helper.delete_expense_for_date(expenses_date)
    for expense in expenses:
        db_helper.insert_expense(expenses_date, expenses.amount, expenses.category, expenses.notes)
